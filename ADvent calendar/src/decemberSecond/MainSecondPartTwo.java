...
public class MainSecondPartTwo {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < commandList.size(); i++) {
			...
			String password = passwordList.get(i).strip();
				if (password.charAt(minimum-1) == letter && password.charAt(maximum-1) != letter) {
					validPasswords++;
					System.out.println("password: " + password + "is valid");
				} else if (password.charAt(minimum-1) != letter && password.charAt(maximum-1) == letter) {
					validPasswords++;
					System.out.println("password: " + password + "is valid");
				}
